...
public class Solution {
    public static void main(String[] args) {
        ...
        soldiers.add(new Soldier("Иванов", 164));
        soldiers.add(new Soldier("Петров", 185));
        soldiers.add(new Soldier("Сидоров", 177));
        soldiers.add(new Soldier("Орлов", 175));
        soldiers.add(new Soldier("Игнатов", 182));
        soldiers.add(new Soldier("Савельев", 178));
